========================================================================
    APPLICATION CONSOLE : vue d'ensemble du projet DebugConsole
========================================================================

AppWizard a créé cette application DebugConsole pour vous.  
Ce fichier contient un résumé du contenu de chacun des fichiers qui
constituent votre application DebugConsole.
...
StdAfx.h, StdAfx.cpp
    ...
    nommé DebugConsole.pch et un fichier de type précompilé nommé StdAfx.obj.
